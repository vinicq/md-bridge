...
ISTQB_CANDIDATES = [
    Path("Arquivos-pdf/QA/Advanced/ISTQB-CTAL-AT-Syllabus-v2.0_EN_.pdf"),
    Path("Arquivos-pdf/QA/Advanced/ISTQB-CTAL-TA-Syllabus-v4.0-EN-4.pdf"),
    Path("Arquivos-pdf/QA/Specialist/ISTQB_CT-AI_Syllabus_v1.0.pdf"),
]
